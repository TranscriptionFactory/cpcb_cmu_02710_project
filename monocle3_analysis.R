...
setwd("Desktop/CPCB/Assignments/Spring_2023/genomics/project/analysis/T-cell-development-master/train_input/")

tcell_data <- read.table("tcell_data.E", sep="\t", header=TRUE, row.names=1, check.names=FALSE)
...
plot_cells(cds, color_cells_by="assignment")
...
plot_cells(cds, color_cells_by="time_point", label_cell_groups=FALSE)
...
save_monocle_objects(cds=cds, directory_path = "cds_out", comment='First pass on T cell dataset. Stored 05-07-2023.')
